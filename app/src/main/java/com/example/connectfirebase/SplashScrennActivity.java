                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    for (QueryDocumentSnapshot document : task.getResult()) {
                                        ...
                                        mListAnnonce.add(new AnnonceModel(document.getString("prix"), document.getString("rue")+" "+document.getString("entourage"),R.drawable.com_facebook_auth_dialog_background));
