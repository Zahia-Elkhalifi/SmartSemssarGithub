...
public class OfferAdapter  extends RecyclerView.Adapter<OfferAdapter.MyViewHolder>{
    private Context ct;
    private ArrayList<OfferModel> mListAnnonce;
    public OfferAdapter(Context ct,ArrayList<OfferModel> mListAnnonce){
        this.ct = ct;
        this.mListAnnonce=mListAnnonce;
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        final OfferModel itemList = mListAnnonce.get(position);
    ...
    public int getItemCount() {
        ...
        if (mListAnnonce!=null){
            return mListAnnonce.size();
        }
        return 0;
    }
